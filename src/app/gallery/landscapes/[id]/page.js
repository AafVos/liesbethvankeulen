...
export default async function GalleryItem({ params }) {
    ...
    return (
      <div className="h-screen flex flex-col overflow-hidden" style={{ backgroundColor: theme.background }}>
        ...
        <main className="flex-1 flex flex-col items-center justify-center px-4">
          ...
          <p>
            <Link href="/gallery/landscapes" className="text-2xl hover:opacity-80 transition-opacity" style={{ color: theme.link }}>
              ←
            </Link>
          </p>
        </main>
  ...
  // Coordinates for the map (Maastricht, Netherlands)
  const coordinates = [50.851368, 5.690973];
    ...
    <div className="h-screen flex flex-col overflow-hidden" style={{ backgroundColor: theme.background }}>
      ...
      <main className="flex-1 flex flex-col px-4 py-2">
        ...
        <div className="flex-1 flex flex-col md:flex-row gap-4 overflow-auto">
          ...
          {/* Text content and map on the right */}
          <div className="md:w-1/2 flex-1 overflow-y-auto pr-2">
            ...
            <div style={{ color: theme.text }}>
              <p className="mb-4 text-sm">{item.description || "No description available."}</p>
              
              {/* Flex container for details and map side-by-side */}
