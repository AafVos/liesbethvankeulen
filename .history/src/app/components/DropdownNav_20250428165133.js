...
export default function DropdownNav({ label, items, href, color }) {
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute left-1/2 -translate-x-1/2 min-w-[180px] bg-white border border-gray-200 shadow-lg rounded z-50 transition-all duration-200 ${open ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'}`}
      >
