...
const Header = ({ title, subtitle, themeName, showNavigation = true }) => {
  ...
  return (
    <header className="relative w-full z-30 py-6 px-6">
      {/* Mobile layout */}
      <div className="md:hidden w-full flex flex-col items-center justify-center gap-2">
        <div className="w-full flex flex-row items-center justify-center mb-1">
          ...
          <div className="flex-1 flex flex-col items-center justify-center min-w-0">
            <Link href="/home" className="cursor-pointer inline-block w-full">
              <h2 
                className="text-2xl tracking-wide drop-shadow-md text-center w-full" 
                style={{ 
                  fontFamily: "'Courier New', Courier, monospace",
                  fontWeight: 400,
              ...
              {subtitle && (
                <div className="text-base mt-1 tracking-wide text-center w-full" style={{
                  fontFamily: "'Courier New', Courier, monospace",
                  color: theme.text,
                  opacity: 0.8,
