      ...
      <div className="flex items-center justify-between w-full">
        ...
        <div>
          <div className="text-center">
            <Link href="/home" className="group cursor-pointer inline-block">
              <h2 
                className="text-3xl tracking-wide drop-shadow-md group-hover:underline" 
                style={{ 
                  fontFamily: "'Courier New', Courier, monospace",
                  fontWeight: 400,
              ...
              {subtitle && (
                <div className="text-base mt-1 tracking-wide group-hover:underline" style={{
                  fontFamily: "'Courier New', Courier, monospace",
                  color: theme.text,
                  opacity: 0.8,
